...
axis(1, at=c(1999,2004,2008,2013), label=year,las=0, cex.lab=1,cex.axis=1.1,tcl=-.25,pos=0) #at 绘制刻度线，label标签
#tcl用来指定刻度线长度，正值表示在图形内部绘制刻度线，负值相反。
axis(side=2,at=seq(0,0.4,0.1),las=2, cex.lab=1, cex.axis=1.1, tcl=-0.25,pos=1999)
